      ...
      <table className="w-full overflow-x-auto">
        <thead>
          <tr className="bg-transparent">
            <th className="border-r border-b border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] p-2.5 text-left text-lg font-semibold">
              {t('feeType', { fallback: 'Fee type' })}
            </th>
            <th className="border-b border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] p-2.5 text-left text-lg font-semibold">
              {t('fee', { fallback: 'Fee' })}
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td
              colSpan={2}
              className="border-b border-[rgba(255,255,255,0.1)] bg-transparent p-2.5 font-semibold"
            >
              {t('additionalFees', { fallback: 'Additional fees' })}
            </td>
          </tr>
          <tr className="border-b border-[rgba(255,255,255,0.1)]">
            <td className="border-r border-[rgba(255,255,255,0.1)] p-2.5">
              {t('processingFee', {
                fallback:
          ...
          <tr>
            <td
              colSpan={2}
              className="border-b border-[rgba(255,255,255,0.1)] p-2.5 font-semibold"
            >
          ...
          <tr>
            ...
            <td className="p-2.5">{t('100Eur', { fallback: '100 EUR' })}</td>
          </tr>
        </tbody>
      </table>
    </div>
