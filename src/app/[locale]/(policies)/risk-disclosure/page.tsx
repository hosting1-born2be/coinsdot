...
export default async function RiskDisclosurePage() {
  ...
  return (
    <>
      <PolicyHero title={t('title', { fallback: 'Risk Disclosure' })} />
      <article className="container mb-10 flex flex-col gap-6 border border-[rgba(255,255,255,0.10)] p-6">
        <Title size="3xl">
      ...
      <PolicyRender
        navigation={[{ label: 'Disclaimer', href: '#disclaimer' }]}
        hideNavigation
      >
