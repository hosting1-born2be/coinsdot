...
export default async function ComplainsProcedurePage() {
  ...
  return (
    <>
      <PolicyHero
        title={t('title', { fallback: 'Complains Procedure' })}
      ...
      <PolicyRender
        navigation={[
          {
            label: t('0.title', { fallback: 'INTRODUCTION' }),
            href: '#introduction',
          },
          {
            label: t('1.title', { fallback: 'INITIATION OF COMPLAINT' }),
            href: '#initiationOfComplaint',
          },
          {
            label: t('2.title', { fallback: 'COMPLAINTS HANDLING PROCEDURE' }),
            href: '#complaintsHandlingProcedure',
          },
          {
            label: t('3.title', { fallback: 'REDRESS AND COMPENSATION' }),
            href: '#redressAndCompensation',
          },
          {
            label: t('4.title', { fallback: 'OTHER' }),
            href: '#other',
          },
        ]}
        sticky
      >
        ...
        >
          ...
          <List
            ...
            values={[
              ...
              t('0.list.3', {
                fallback:
                  'the Act on Payment Services (Act No. 492/2009 Coll.),',
              }),
              t('0.list.4', {
                fallback:
        ...
        <PolicySectionLayout
          titleId="complaintsHandlingProcedure"
          className="gap-6"
        ...
        <PolicySectionLayout
          titleId="redressAndCompensation"
        ...
        <PolicySectionLayout
          titleId="other"
          title={t('4.title', { fallback: '5. OTHER' })}
        >
          <PolicyText flex>
            <span>5.1</span>
            <span>
