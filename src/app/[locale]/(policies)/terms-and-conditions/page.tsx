...
export default async function TermsAndConditionsPage() {
  ...
  return (
    <>
      ...
      <PolicyRender
        navigation={[
          { label: t('0.0', { fallback: '1. Summary' }), href: '#summary' },
          {
            label: t('0.1', { fallback: '2. Key Definitions' }),
            href: '#keyDefinitions',
          },
          {
            label: t('0.2', { fallback: '3. Eligibility' }),
            href: '#eligibility',
          },
          {
            label: t('0.3', {
            ...
            href: '#generalObligationsAndRestrictions',
          },
          {
            label: t('0.4', { fallback: '5. Exchange Terms' }),
            href: '#exchangeTerms',
          },
          {
            label: t('0.5', {
              fallback: '6. KYC and Reversal Transaction Policy',
            }),
            href: '#kycAndReversalTransactionPolicy',
          },
          {
            label: t('0.6', { fallback: '7. Risk Disclosure Statement' }),
            href: '#riskDisclosureStatement',
          },
          {
            label: t('0.7', { fallback: '8. Intellectual Property' }),
            href: '#intellectualProperty',
          },
          {
            label: t('0.8', { fallback: '9. Third-Party Content' }),
            href: '#thirdPartyContent',
          },
          {
            label: t('0.9', { fallback: '10. Customer Complaints Procedure' }),
            href: '#customerComplaintsProcedure',
          },
          {
            label: t('0.10', {
              fallback:
            ...
            href: '#discontinuanceOfServiceSuspensionAndTermination',
          },
          {
            label: t('0.11', {
              fallback: '12. Limitation of Liability, Disclaimer of Warranties',
            }),
            href: '#limitationOfLiabilityDisclaimerOfWarranties',
          },
          {
            label: t('0.12', { fallback: '13. Applicable Law' }),
            href: '#applicableLaw',
          },
          {
            label: t('0.13', { fallback: '14. Miscellaneous' }),
            href: '#miscellaneous',
          },
        ]}
      >
        ...
        >
          ...
          <PolicyText flex>
            ...
            {t('2.6', {
              fallback:
                '“Funds” shall mean the Crypto-assets or Fiat currency.',
            })}
          </PolicyText>
          <PolicyText flex>
            <span>2.8</span>
        ...
        >
          ...
          <PolicyText flex>
            ...
            <span>
              ...
              <Link
                href="mailto:support@coinsdot.io"
        ...
        >
          ...
          <PolicyText bold flex>
            ...
            <span>
              {t('5.26', {
                fallback: 'Cancellation of order (buying/selling).',
              })}
            </span>
          </PolicyText>
          <PolicyText flex>
        ...
        <PolicySectionLayout
          ...
          titleId="kycAndReversalTransactionPolicy"
        >
          <PolicyText flex>
            <span>6.1</span>
            <span>
        ...
        >
          <PolicyText bold flex>
            <span>8.1</span>
            <span>
              {t('8.0', { fallback: 'Intellectual Property Rights.' })}
            </span>
          </PolicyText>
          <PolicyText flex>
            <span>8.1.1</span>
        ...
        >
          ...
          <PolicyText flex>
            ...
            <span>
              {t('10.7', {
                fallback: 'Your Coinsmax profile number (if any).',
              })}
            </span>
          </PolicyText>
          <PolicyText flex>
