...
export default async function AMLPolicyPage() {
  ...
  return (
    <>
      <PolicyHero
        title={t('title', { fallback: 'AML Policy' })}
        lastUpdated={t('lastUpdated', {
          fallback: 'Last updated on September 9th, 2025',
        })}
        titleClassName="text-[60px] leading-[60px] tracking-[-0.9px] max-md:text-[36px] max-md:leading-[120%] max-md:tracking-[-0.72px]"
      />
      <PolicyRender
        navigation={[
          {
            label: t('0.title', { fallback: 'About the Company' }),
            href: '#aboutTheCompany',
          },
          {
            label: t('1.title', { fallback: 'AML/CTF Commitment' }),
            href: '#amlCtfCommitment',
          },
          {
            label: t('2.title', { fallback: 'Legal and Regulatory Framework' }),
            href: '#legalAndRegulatoryFramework',
          },
          {
            label: t('3.title', { fallback: 'AML/CTF Policy Overview' }),
            href: '#amlCtfPolicyOverview',
          },
          {
            label: t('4.title', {
              fallback: 'Customer Responsibilities and Obligations',
            }),
            href: '#customerResponsibilitiesAndObligations',
          },
          {
            label: t('5.title', { fallback: 'Customer Identification (KYC)' }),
            href: '#customerIdentificationKyc',
          },
          {
            label: t('6.title', { fallback: 'Ongoing Monitoring' }),
            href: '#ongoingMonitoring',
          },
          {
            label: t('7.title', {
              fallback: 'Sanctioned Countries and High-Risk Jurisdictions',
            }),
            href: '#sanctionedCountriesAndHighRiskJurisdictions',
          },
          {
            label: t('8.title', { fallback: 'Transaction Monitoring' }),
            href: '#transactionMonitoring',
          },
          {
            label: t('9.title', { fallback: 'Reporting Obligations' }),
            href: '#reportingObligations',
          },
          {
            label: t('10.title', { fallback: 'Customer Obligations' }),
            href: '#customerObligations',
          },
          {
            label: t('11.title', {
              fallback: 'Record Keeping & Confidentiality',
            }),
            href: '#recordKeepingAndConfidentiality',
          },
          {
            label: t('12.title', { fallback: 'Governance and Training' }),
            href: '#governanceAndTraining',
          },
          {
            label: t('13.title', { fallback: 'Policy Review and Updates' }),
            href: '#policyReviewAndUpdates',
          },
        ]}
      >
        <PolicySectionLayout
          titleId="aboutTheCompany"
        ...
        <PolicySectionLayout
          titleId="legalAndRegulatoryFramework"
        ...
        <PolicySectionLayout
          titleId="customerResponsibilitiesAndObligations"
          title={t('4.title', {
            fallback: 'Customer Responsibilities and Obligations',
          })}
        >
        ...
        <PolicySectionLayout
          titleId="customerIdentificationKyc"
        ...
        <PolicySectionLayout
          titleId="sanctionedCountriesAndHighRiskJurisdictions"
          title={t('7.title', {
            fallback: 'Sanctioned Countries and High-Risk Jurisdictions',
          })}
        >
        ...
        <PolicySectionLayout
          titleId="recordKeepingAndConfidentiality"
          title={t('11.title', {
            fallback: 'Record Keeping & Confidentiality',
          })}
        >
        ...
        <PolicySectionLayout
          titleId="policyReviewAndUpdates"
