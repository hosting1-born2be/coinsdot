        ...
        navigation={[
          {
            ...
            href: '#whichPersonalDataDoWeCollectAboutYou',
          },
          {
            label: t('2.title', {
              fallback: 'How Do We Collect Personal Data?',
            }),
            href: '#howDoWeCollectPersonalData',
          },
          {
            label: t('3.title', {
              fallback:
            ...
            href: '#whatAreThePurposesOfTheCollectionAndProcessingOfData',
          },
          {
            label: t('4.title', {
              fallback: 'Lawful Basis to Processing',
            }),
            href: '#lawfulBasisToProcessing',
          },
          {
            label: t('5.title', {
              fallback: 'Sharing Personal Data with Third Parties',
            }),
            href: '#sharingPersonalDataWithThirdParties',
          },
          {
            label: t('6.title', {
              fallback: 'Your Personal Data Rights',
            }),
            href: '#yourPersonalDataRights',
          },
          {
            label: t('7.title', {
              fallback: 'Exercising Your Rights',
            }),
            href: '#exercisingYourRights',
          },
          {
            label: t('8.title', {
          ...
          },
          {
            ...
            href: '#dataProtectionOfUsingDigitalAssetsAndBlockchains',
          },
          {
            label: t('14.title', {
              fallback: 'Marketing and Online Communication',
            }),
            href: '#marketingAndOnlineCommunication',
          },
          {
            label: t('15.title', {
              fallback: 'Children Under 18',
            }),
            href: '#childrenUnder18',
          },
          {
            label: t('16.title', {
          ...
          },
          {
            ...
            href: '#updatesToThePrivacyPolicy',
          },
        ]}
      >
        <PolicyText>
        ...
        <PolicySectionLayout
          titleId="whichPersonalDataDoWeCollectAboutYou"
          title={t('1.title', {
            fallback: 'Which Personal Data Do We Collect About You?',
          })}
        >
        ...
        <PolicySectionLayout
          titleId="howDoWeCollectPersonalData"
          title={t('2.title', {
            fallback: 'How Do We Collect Personal Data?',
          })}
          className="gap-6"
        ...
        <PolicySectionLayout
          titleId="whatAreThePurposesOfTheCollectionAndProcessingOfData"
          title={t('3.title', {
            fallback:
              'What Are the Purposes of the Collection and Processing of Data?',
          })}
        ...
        <PolicySectionLayout
          titleId="lawfulBasisToProcessing"
          className="gap-6"
          title={t('4.title', {
            fallback: 'Lawful Basis to Processing',
          })}
        ...
        <PolicySectionLayout
          titleId="sharingPersonalDataWithThirdParties"
          className="gap-6"
          title={t('5.title', {
            fallback: 'Sharing Personal Data with Third Parties',
          })}
        ...
        <PolicySectionLayout
          titleId="yourPersonalDataRights"
          title={t('6.title', {
            fallback: 'Your Personal Data Rights',
          })}
          className="gap-6"
        ...
        <PolicySectionLayout
          titleId="transferOfYourPersonalData"
          title={t('9.title', {
            fallback: 'Transfer of Your Personal Data',
          })}
          className="gap-6"
          ...
          <div className="flex flex-col gap-6 border border-[rgba(255,255,255,0.1)] p-6">
            ...
            <div className="flex flex-col">
              ...
              <PolicyText>
                ...
                {t('9.12', {
                  fallback:
                    'If you would like more information on the specific mechanism used for international transfers of your Personal Data, or if you would like to request a copy of the applicable safeguards (e.g., SCCs), please contact us at: dpo@coinsdot.io.',
                })}
              </PolicyText>
            </div>
          </div>
        ...
        <PolicySectionLayout
          titleId="dataProtectionOfUsingDigitalAssetsAndBlockchains"
          title={t('12.title', {
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            <Link href="https://exchange.coinsdot.io/register">
        ...
        <PolicySectionLayout
          titleId="marketingAndOnlineCommunication"
          title={t('14.title', {
            fallback: 'Marketing And Online Communication',
          })}
          className="gap-6"
        ...
        <PolicySectionLayout
          titleId="updatesToThePrivacyPolicy"
          title={t('17.title', {
            fallback: 'Updates to the Privacy Policy',
          })}
          className="gap-6"
